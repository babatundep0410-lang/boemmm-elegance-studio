    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-16">
        <div className="relative flex items-stretch max-w-[85%] max-h-[85%]">
          {/* Scrollbar — flush left of image */}
          {showScrollBar && (
            <div className="w-[3px] flex flex-col mr-2 shrink-0">
          ...
          {hasImages ? (
            <img
              ...
              className="w-full h-full object-contain image-sharp border border-foreground/80"
              loading="eager"
              decoding="sync"
              fetchPriority="high"
            />
